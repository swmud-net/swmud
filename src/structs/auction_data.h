...
struct	auction_data
{
	...
	char				* seller_name;
	char				* desc;			/*!< kr�tki opis gracza sprzedaj�cego */
	...
	int64				quantity;		/*!< ilo� sprzedawnych towar�w*/
	...
	bool				max_cash_auction;	/*!< czy chce by zarobi� jak najwi�cej na aukcji, czy sprzeda� caly towar */
};
