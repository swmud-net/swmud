...
struct	pc_data
{
	...
	int					security; //byTrog
	/* Added by Thanos */
	int					status_width; //szeroko�� i wysokosc lini statusu
	int					status_height;
	...
	int					line_nr; // w kt�rej lini jest kursor (do qedit () )
	int					mprog_edit;
#if defined( ARMAGEDDON )
	int					practices;
#endif
	char				* editinfo;	/* w�asne notatki olcman�w */
	char				* ignorelist;	/* lista ignorowanych os�b */
	/* handel data */
